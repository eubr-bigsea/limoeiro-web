      ...
      <div class="d-flex">
        <div class="w-50 p-3">
          ...
          <div class="d-flex justify-content-end gap-2 mt-2">
            <button class="btn btn-outline-primary me-2" @click="selectAllPermissions">
              Selecionar todos
            </button>
            <button class="btn btn-outline-secondary" @click="clearPermissions">Limpar</button>
          </div>
          </div>
        </div>
        <!-- lado direito -->
...
const addUser = () => {
  if (newUser.value !== null)
    state.users.push(newUser.value)
  listing.value.refresh()
}
